...
const activities=[{title:"Diga o nome",area:"Linguagem",icon:"🐸",goal:"Nomeação",kind:"name",instruction:"Olhe a figura e fale o nome dela."},{title:"Quem é?",area:"Linguagem",icon:"🐶",goal:"Vocabulário",kind:"name",instruction:"Diga quem aparece e o que está fazendo."},{title:"Complete a frase",area:"Linguagem",icon:"🧩",goal:"Construção de frases",kind:"turn",instruction:"Complete a frase com uma palavra que faça sentido."},{title:"Conte a história",area:"Linguagem",icon:"📖",goal:"Narrativa",kind:"turn",instruction:"Conte com suas palavras o que aconteceu."},{title:"Rimas",area:"Consciência fonológica",icon:"🎵",goal:"Percepção de rimas",kind:"rhyme",instruction:"Escolha a palavra que combina com o som final."},{title:"Bate-palmas",area:"Consciência fonológica",icon:"👏",goal:"Segmentação silábica",kind:"rhyme",instruction:"Fale a palavra e bata palmas para cada sílaba."},{title:"Qual começa igual?",area:"Consciência fonológica",icon:"🔤",goal:"Aliteração",kind:"rhyme",instruction:"Encontre a palavra que começa com o mesmo som."},{title:"Junte os sons",area:"Consciência fonológica",icon:"🧠",goal:"Fusão de sons",kind:"rhyme",instruction:"Junte os sons e descubra a palavra."},{title:"Caça às letras",area:"Leitura e escrita",icon:"🔎",goal:"Reconhecimento de letras",kind:"name",instruction:"Encontre a letra pedida."},{title:"Som e letra",area:"Leitura e escrita",icon:"🔤",goal:"Grafema e fonema",kind:"name",instruction:"Diga o som representado pela letra."},{title:"Leia a palavra",area:"Leitura e escrita",icon:"📚",goal:"Leitura",kind:"name",instruction:"Leia a palavra em voz alta."},{title:"Complete a palavra",area:"Leitura e escrita",icon:"✏️",goal:"Escrita",kind:"name",instruction:"Complete a palavra com a letra que falta."},{title:"Minha vez, sua vez",area:"Comunicação social",icon:"💬",goal:"Turnos",kind:"turn",instruction:"Espere sua vez e participe da conversa."},{title:"Pergunte e responda",area:"Comunicação social",icon:"❓",goal:"Interação",kind:"turn",instruction:"Faça uma pergunta e responda ao outro."},{title:"Como eu me sinto?",area:"Comunicação social",icon:"🙂",goal:"Emoções",kind:"turn",instruction:"Conte como você se sente e por quê."},{title:"Fale com calma",area:"Fluência",icon:"🌬️",goal:"Consciência da fala",kind:"turn",instruction:"Fale uma frase com tranquilidade, conforme orientação da fono."},{title:"Voz confortável",area:"Voz",icon:"🎙️",goal:"Percepção vocal",kind:"turn",instruction:"Produza uma frase em uma voz confortável, sem forçar."},{title:"Consciência da boca",area:"Orofacial",icon:"👄",goal:"Consciência orofacial",kind:"turn",instruction:"Faça somente os movimentos orientados pela fono."},{title:"Nomeie e descreva",area:"Vocabulário",icon:"🧸",goal:"Descrição",kind:"name",instruction:"Diga o nome e duas características do objeto."}];
